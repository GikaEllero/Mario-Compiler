...
public class Tradutor extends atribuicaoBaseListener{
    ...
    public void enterLeia(atribuicaoParser.LeiaContext ctx) {
        atribuicaoParser.InputContext input = (atribuicaoParser.InputContext) ctx.getParent();
        String var = input.var().getText();

        String tipo = verificaTipo(var);
        switch (tipo) {
            case "mario":
                System.out.print("entrada.nextInt");
                break;
            case "luigi":
                System.out.print("entrada.nextDouble");
                break;
            case "peach":
